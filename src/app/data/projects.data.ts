  ...
  // 2026
  {
    ...
    variants: {
      all: {
        ...
        tags: [
          { label: 'Side Project', type: 'category' },
          { label: 'Interaction Design', type: 'category' },
          { label: 'React', type: 'tech' },
          { label: 'DeepL API', type: 'tech' },
        ],
        type: 'both',
      },
      design: {
      ...
      dev: {
        ...
        tags: [
          ...
          { label: 'Side Project', type: 'category' },
          { label: 'React', type: 'tech' },
          { label: 'html-to-canvas', type: 'tech' },
          { label: 'docx.js', type: 'tech' },
        ],
        type: 'both',
      },
    },
    drawerContent: {
      design: {
        ...
        tech: ['React', 'Figma', 'DeepL API'],
        highlightTech: [],
      },
      dev: {
        problem:
          'Rendering CSS-to-PDF affidabile con layout complessi è un problema aperto. <strong>La scelta tecnica di usare template a colonna singola è stata guidata da questo vincolo — non da una preferenza estetica.</strong>',
        steps: [
          {
            n: '01',
          ...
          {
            n: '03',
            title: 'Stato e performance',
            desc: 'State management con useReducer per gestire la sincronizzazione live tra editor e preview senza re-render inutili.',
          },
          {
            n: '04',
            title: 'Export DOCX',
        ...
        tech: ['React', 'useReducer', 'docx.js', 'html-to-canvas', 'DeepL API'],
        highlightTech: ['React', 'useReducer', 'docx.js', 'html-to-canvas'],
      },
    },
  },
  // 2025
  {
    ...
    variants: {
      all: {
        ...
        tags: [
          ...
          { label: 'UX Research', type: 'category' },
      ...
      dev: {
        ...
        desc: 'Angular + NgRx per sincronizzazione filtri, virtual scroll custom e export asincrono con Web Worker.',
        tags: [
          { label: 'Frontend', type: 'category' },
          { label: 'Enterprise', type: 'category' },
          { label: 'Angular', type: 'tech' },
          { label: 'NgRx', type: 'tech' },
        ],
        type: 'design',
      },
    },
    drawerContent: {
      ...
      dev: {
        ...
        tech: ['Angular', 'NgRx', 'RxJS', 'Web Worker', 'Figma'],
        highlightTech: ['Angular', 'NgRx', 'RxJS', 'Web Worker'],
      },
    },
  },
  {
    ...
    variants: {
      all: {
        ...
        desc: 'Design system e architettura frontend per piattaforma B2C. Gestione stato complessa, performance e accessibilità.',
        tags: [
          { label: 'Frontend', type: 'category' },
          { label: 'Design System', type: 'category' },
          { label: 'Angular', type: 'tech' },
          { label: 'SCSS', type: 'tech' },
        ],
        type: 'dev',
      },
      design: {
    ...
    drawerContent: {
      ...
      dev: {
        ...
        tech: ['Angular', 'Style Dictionary', 'Storybook', 'SCSS'],
  ...
  },
  {
    ...
    variants: {
      all: {
        ...
        tags: [
          { label: 'Freelance', type: 'category' },
          { label: 'Web Design', type: 'category' },
          { label: 'Angular', type: 'tech' },
          { label: 'Figma', type: 'tech' },
        ],
        type: 'both',
      ...
      design: {
        ...
        tags: [
          { label: 'Web Design', type: 'category' },
          { label: 'Brand Identity', type: 'category' },
          { label: 'Figma', type: 'tech' },
        ],
        type: 'both',
      },
    ...
    drawerContent: {
      ...
      dev: {
        ...
        tech: ['Angular 19', 'SSG', 'SCSS', 'Vercel'],
  ...
  },
  {
    ...
    drawerContent: {
      ...
      dev: {
        ...
        tech: ['Flutter 3', 'Angular 17', 'Bluetooth', 'Wi-Fi Direct', 'Figma'],
  ...
  // 2024
  {
    ...
    variants: {
      all: {
        ...
        tags: [
          { label: 'Accessibilità', type: 'category' },
          { label: 'Enterprise', type: 'category' },
          { label: 'Angular', type: 'tech' },
        ],
        type: 'dev',
      ...
      design: {
        ...
        tags: [
          { label: 'Accessibilità', type: 'category' },
          { label: 'UX', type: 'category' },

          { label: 'NVDA', type: 'tech' },
        ],
        type: 'dev',
      },
      dev: {
      ...
      design: {
        ...
        steps: [
          ...
          },
          {
            ...
            desc: 'Test manuali con NVDA e VoiceOver.',
          },
        ],
        metrics: [
  ...
  },
  {
    ...
    drawerContent: {
      ...
      dev: {
        ...
        tech: ['Angular', 'RxJS', 'WebSocket', 'Figma'],
  ...
  // 2023
  {
    ...
    variants: {
      all: {
        ...
        tags: [
          { label: 'Enterprise', type: 'category' },
          { label: 'Gamification', type: 'category' },
          { label: 'Vue', type: 'tech' },
          { label: 'Strapi', type: 'tech' },
        ],
        type: 'dev',
      },
      design: {
    ...
    drawerContent: {
      ...
      dev: {
        ...
        metrics: [
          ...
          { value: 'Strapi', label: 'CMS backend' },
          { value: '0', label: 'Deploy per update contenuti' },
        ],
        tech: ['Vue', 'Vuex', 'Strapi', 'REST API'],
        highlightTech: ['Vue', 'Strapi'],
      },
    },
  },
  {
    ...
    variants: {
      all: {
        ...
        tags: [
          { label: 'SaaS', type: 'category' },
          { label: 'Prodotto', type: 'category' },
          { label: 'Angular', type: 'tech' },
          { label: 'Flutter', type: 'tech' },
        ],
        type: 'both',
    ...
    drawerContent: {
      ...
      dev: {
        ...
        tech: ['Angular', 'Flutter', 'RxJS', 'Figma'],
    ...
    variants: {
      all: {
        ...
        tags: [
          ...
          { label: 'Università', type: 'category' },
      ...
      design: {
        ...
        tags: [
          { label: 'Data Design', type: 'category' },
          { label: 'IR', type: 'category' },
          { label: 'Python', type: 'tech' },
        ],
        type: 'dev',
      },
  ...
  // 2022
  {
    ...
    variants: {
      ...
      dev: {
        ...
        tags: [
          { label: 'Frontend', type: 'category' },
          { label: 'Architettura', type: 'category' },
    ...
    drawerContent: {
      ...
      dev: {
        ...
        tech: ['Angular 9', 'RxJS', 'C# API', 'Figma'],
  ...
  },
  {
    ...
    drawerContent: {
      design: {
        ...
        tech: ['Figma', 'Angular', 'Mechanical Turk'],
        highlightTech: [],
      },
      dev: {
        problem:
        ...
        tech: ['Angular 15', 'Angular 8', 'Python', 'Figma'],
  ...
  // 2021
  {
    ...
    variants: {
      ...
      design: {
        ...
        tags: [
          { label: 'UI', type: 'category' },
          { label: 'Customizzazione', type: 'category' },
          { label: 'Vue', type: 'tech' },
        ],
        type: 'dev',
      },
  ...
  },
  {
    ...
    drawerContent: {
      ...
      dev: {
        ...
        tech: ['Flutter 2', 'Hive', 'Provider', 'Figma'],
